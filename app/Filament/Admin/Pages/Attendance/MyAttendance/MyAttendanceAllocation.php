...
class MyAttendanceAllocation extends Page
{
    use InteractsWithAttendanceSidebar;
    use RegistersAdminNavigation;

    protected static ?string $slug = 'attendance/my-attendance/allocation';
    ...
    protected function getViewData(): array
    {
        return array_merge(parent::getViewData(), $this->getAttendanceSidebarViewData(), [
            'placeholderText' => __('filament.attendance.my_attendance.allocation.placeholder'),
        ]);
    }
    ...
    {
        return __('filament.attendance.my_attendance.allocation.breadcrumb');
    }
}
